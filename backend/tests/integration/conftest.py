...
# Generated by scripts/generate_corpus.py (Spec 26, T2.0): the corpus is grown
# from the golden-set design to ~200 items so it actually discriminates the
# eval queries. Regenerate + update these together if the target changes.
EXPECTED_MOVIES = 182
EXPECTED_SHOWS = 18
